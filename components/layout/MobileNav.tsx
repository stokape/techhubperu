  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        <Image src="/images/logo/logo-light.png" alt="TechHub Perú" width={229} height={155} className="h-11 w-auto dark:hidden" />
        <Image src="/images/logo/logo-dark.png" alt="TechHub Perú" width={265} height={144} className="hidden h-11 w-auto dark:block" />
